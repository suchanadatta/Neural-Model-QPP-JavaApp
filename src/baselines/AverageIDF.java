...
public class AverageIDF {
    ...
    public AverageIDF(String indexPath, String queryPath, String avgIdfPath) throws IOException {
        ...
        fileWriter = new FileWriter(avgIdfPath + "avgIDF_trec_sigmoid");
    }
    ...
    public void calculateQueryAvgIdf() throws SAXException, Exception {
        ...
        for (TRECQuery query : queries) {
            ...
            fileWriter.write(query.qid + "\t" + df.format(termIdf) + "\n");
        }
    }
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        String usage = "java AverageIDF <arguments in order> :\n"
                + "1. Path of the index.\n"
