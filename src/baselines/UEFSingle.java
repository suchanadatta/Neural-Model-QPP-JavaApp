...
public class UEFSingle {
    ...
    public UEFSingle(Properties prop) throws IOException, Exception {
...
//        System.out.println("COLPTS : " + colPTS.getCF());
    ...
    public void computeUEF() throws Exception {
...
//            resFileWriterRLM.close();
            spearnanVal = spc.spearman(mapLM, mapRLM);
//            System.out.println("Spearman : " + spearnanVal);
            
            System.out.println(query.qid + "\t" + spearnanVal * wrigVal.get(query.qid));
        }
    }
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        UEFSingle uef = new UEFSingle(prop);
