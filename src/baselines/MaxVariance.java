...
public class MaxVariance {
    ...
    public MaxVariance(Properties prop) throws IOException, Exception {
...
//        System.out.println("$$$$$$$$$ : " + perQueryInfo.size());
        ...
        // calculate the estimator \sigma_3
...
//                args[0] = "foo.properties";
            ...
            MaxVariance avar = new MaxVariance(prop);
